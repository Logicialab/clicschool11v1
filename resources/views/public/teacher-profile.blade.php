                        ...
                        <div class="card">
                            ...
                            <div class="card-body p-md-5">
                                <div class="d-flex flex-column gap-5">
                                    <div class="mt-n8"><img src="/assets/images/mentor/mentor-img-single.jpg"
                                            alt="mentor 1" class="img-fluid rounded-3 mt-n8"></div>
                                    <div class="d-flex flex-column gap-5">
                                        <div class="d-flex flex-column gap-3">
                                            <div class="d-flex flex-md-row flex-column justify-content-between gap-2">
                                                <div>
                                                    <h1 class="mb-0"> محمد علي</h1>
                        ...
                        <div class="card">
                            <div class="card-body p-md-5 d-flex flex-column gap-3">
                                ...
                                <div class="d-flex flex-column">
                                    <p class="mb-1">مصمم فائز بجوائز يمتلك أكثر من 7 سنوات من الخبرة في تصميم تجربة
                                        المستخدم وتصميم المنتجات والعلامات التجارية. لقد قمت بإرشاد وتوظيف الطلاب في وظائف
                                        التصميم في الولايات المتحدة وأوروبا واليابان والهند. أنا في مهمة لإطلاق سراح الخبراء
                                        في التصميم، من خلال تعزيز قدراتهم الإبداعية، وفتح فرص عمل رائعة بدوام كامل، وإشعال
                                        تأثيرهم في الصناعة من خلال مغامرات إبداعية مذهلة!</p>

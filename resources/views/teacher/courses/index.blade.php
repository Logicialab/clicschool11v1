...
<div class="card mb-4">
    ...
    <div class="card-header d-flex">
        ...
        <div class="col-md-2">
            <a href="{{route('teacher.formation.create')}}" class="btn btn-primary d-none d-md-block">إضافة دورة</a>
        </div>
    </div>
    <!-- Card body -->
    <div class="card-body">
                ...
                <tr>
                    <td>
                        <div class="d-flex align-items-center">
                            <div>
                                <a href="{{ route('teacher.course.show', $course->slug) }}">
                            ...
                            <div class="ms-3">
                                <h4 class="mb-1 h5">
                                    <a href="{{ route('teacher.course.show', $course->slug) }}" class="text-inherit">{{ \Illuminate\Support\Str::limit($course->title, 50, '...') }}</a>
                                </h4>
                                <ul class="list-inline fs-6 mb-0">
                                    <li class="list-inline-item">
                                        ...
                                        @if($course->teacher)
                                            <span>{{ $course->teacher->name." ".$course->teacher->name }}</span>
                                        @else
                                            <span>-</span>
                                        @endif
                                    </li>

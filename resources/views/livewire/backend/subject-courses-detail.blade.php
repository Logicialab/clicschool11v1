            ...
            <thead class="text-gray-700">
                <tr>
                    ...
                    <th class="px-4 py-3 text-left">
                        @lang('crud.subject_courses.inputs.title')
                    </th>
                    <th class="px-4 py-3 text-left">
                        @lang('crud.subject_courses.inputs.slug')
                    </th>
                    <th class="px-4 py-3 text-left">
                        @lang('crud.subject_courses.inputs.description')
                    </th>
                    <th class="px-4 py-3 text-left">
                        @lang('crud.subject_courses.inputs.image')
                    </th>
                    <th class="px-4 py-3 text-left">
                        @lang('crud.subject_courses.inputs.body')
                    </th>
                    <th class="px-4 py-3 text-right">
                        @lang('crud.subject_courses.inputs.order')
                    </th>
                    <th class="px-4 py-3 text-left">
                        @lang('crud.subject_courses.inputs.teacher_id')
                    </th>
                    <th class="px-4 py-3 text-left">
                        @lang('crud.subject_courses.inputs.active')
                    </th>
                    <th></th>
                </tr>
            </thead>

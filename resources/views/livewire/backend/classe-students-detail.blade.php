            ...
            <thead class="text-gray-700">
                <tr>
                    ...
                    <th class="px-4 py-3 text-left">
                        @lang('crud.classe_students.inputs.user_id')
                    </th>
                    <th class="px-4 py-3 text-left">
                        @lang('crud.classe_students.inputs.first_name')
                    </th>
                    <th class="px-4 py-3 text-left">
                        @lang('crud.classe_students.inputs.last_name')
                    </th>
                    <th class="px-4 py-3 text-left">
                        @lang('crud.classe_students.inputs.nickname')
                    </th>
                    <th class="px-4 py-3 text-left">
                        @lang('crud.classe_students.inputs.home_adress')
                    </th>
                    <th class="px-4 py-3 text-left">
                        @lang('crud.classe_students.inputs.street')
                    </th>
                    <th class="px-4 py-3 text-left">
                        @lang('crud.classe_students.inputs.neighborhood')
                    </th>
                    <th class="px-4 py-3 text-left">
                        @lang('crud.classe_students.inputs.city')
                    </th>
                    <th class="px-4 py-3 text-left">
                        @lang('crud.classe_students.inputs.school_name')
                    </th>
                    <th class="px-4 py-3 text-left">
                        @lang('crud.classe_students.inputs.student_level')
                    </th>
                    <th class="px-4 py-3 text-left">
                        @lang('crud.classe_students.inputs.name_guardian')
                    </th>
                    <th class="px-4 py-3 text-left">
                        @lang('crud.classe_students.inputs.Profession')
                    </th>
                    <th class="px-4 py-3 text-left">
                        @lang('crud.classe_students.inputs.etablissement_travail')
                    </th>
                    <th></th>
                </tr>
            </thead>

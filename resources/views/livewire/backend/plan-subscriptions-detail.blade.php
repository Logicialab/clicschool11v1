                ...
                <div>
                    <x-inputs.group class="w-full">
                        <x-inputs.select
                            ...
                            label="User"
                            wire:model="subscription.user_id"
                        >
        ...
        <table class="w-full max-w-full mb-4 bg-transparent">
            <thead class="text-gray-700">
                <tr>
                    ...
                    <th class="px-4 py-3 text-left">
                        @lang('crud.plan_subscriptions.inputs.user_id')
                    </th>
                    <th class="px-4 py-3 text-left">
                        @lang('crud.plan_subscriptions.inputs.start_date')
                    </th>
                    <th class="px-4 py-3 text-left">
                        @lang('crud.plan_subscriptions.inputs.end_date')
                    </th>
                    <th class="px-4 py-3 text-left">
                        @lang('crud.plan_subscriptions.inputs.status')
                    </th>
                    <th></th>
                </tr>
            </thead>
            <tbody class="text-gray-600">
                ...
                <tr class="hover:bg-gray-100">
                    ...
                    <td class="px-4 py-3 text-left">
                        {{ optional($subscription->user)->name ?? '-' }}
                    </td>
                    <td class="px-4 py-3 text-left">

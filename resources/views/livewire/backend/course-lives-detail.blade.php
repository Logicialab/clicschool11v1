            ...
            <thead class="text-gray-700">
                <tr>
                    ...
                    <th class="px-4 py-3 text-left">
                        @lang('crud.course_lives.inputs.teacher_id')
                    </th>
                    <th class="px-4 py-3 text-left">
                        @lang('crud.course_lives.inputs.url')
                    </th>
                    <th class="px-4 py-3 text-left">
                        @lang('crud.course_lives.inputs.scheduled_at')
                    </th>
                    <th class="px-4 py-3 text-right">
                        @lang('crud.course_lives.inputs.duration')
                    </th>
                    <th class="px-4 py-3 text-left">
                        @lang('crud.course_lives.inputs.active')
                    </th>
                    <th></th>
                </tr>
            </thead>

            ...
            <div class="row" bis_skin_checked="1">
                ...
                <div class="col-lg-4 col-md-6 col-12" bis_skin_checked="1">
                    ...
                    <div class="card mb-4 card-hover" bis_skin_checked="1">
                        <a href="{{ route('student.subjects.show', $subject->slug) }}"><img src="/storage/{{$subject->image}}" alt="course"
                                class="card-img-top"></a>
                        <!-- Card body -->
                        <div class="card-body" bis_skin_checked="1">
                            <h4 class="mb-2 text-truncate-line-2"><a href="{{ route('student.subjects.show', $subject->slug) }}" class="text-inherit">{{$subject->title}}</a></h4>
                            <!-- List inline -->

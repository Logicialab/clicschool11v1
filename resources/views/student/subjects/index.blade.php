...
@section('student.content')
    ...
    <div class="card mb-4">
        ...
        <div class="card-header d-flex">
            <div class="col-md-10">
                <h3 class="mb-0"> المواد الدراسية - {{ $classe->title }}</h3>
                <span>{{ $classe->description }}</span><br>
                <span>العام الدراسي : {{ $classe->annee_scolaire }}</span>
            </div>
        </div>
        <!-- Card body -->
        <div class="card-body">
    ...
    <div class="tab-content" bis_skin_checked="1">
                ...
                @foreach ($subjects as $subject)
                    <div class="col-lg-4 col-md-6 col-12" bis_skin_checked="1">
                        ...
                        <div class="card mb-4 card-hover" bis_skin_checked="1">
                            ...
                            <a href="{{ route('student.subjects.show', $subject->slug) }}">
                        
                            @if (file_exists( $subject->image))
                                <img src="/storage/{{ $subject->image }}" style="min-width: 100px">
                            @else
                            ...
                            <div class="card-body" bis_skin_checked="1">
                                <h4 class="mb-2 text-truncate-line-2"><a
                                        ...
                                        class="text-inherit">{{ $subject->title }}</a></h4>
                                <!-- List inline -->
                            ...
                            <div class="card-footer" bis_skin_checked="1">
                                ...
                                <div class="row align-items-center g-0" bis_skin_checked="1">
                                    ...
                                    <div class="col ms-2" bis_skin_checked="1">
                                        <span>عدد الدروس </span><span>0</span>
                                    </div>
                                    <div class="col-auto" bis_skin_checked="1">
                                        <a href="#" class="text-reset bookmark">
                                            <i class="fe fe-bookmark fs-4"></i>
        ...
        <!-- Tab pane -->
        <div class="tab-pane fade pb-4" id="tabPaneList" role="tabpanel" aria-labelledby="tabPaneList" bis_skin_checked="1">
            <!-- Card -->
            <div class="card mb-4 card-hover" bis_skin_checked="1">

<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            @lang('crud.teacher_payments.index_title')
        </h2>
    </x-slot>
                ...
                <div class="block w-full overflow-auto scrolling-touch">
                    <table class="w-full max-w-full mb-4 bg-transparent">
                        ...
                        <tbody class="text-gray-600">
                            @forelse($teacherPayments as $teacherPayment)
                            <tr class="hover:bg-gray-50">
                                ...
                                >
                                    ...
                                    >
                                        ...
                                        <a
                                            href="{{ route('teacher-payments.edit', $teacherPayment) }}"
                                            class="mr-1"
                                        >
                                            <button
                                                type="button"
                                        ...
                                        @endcan @can('view', $teacherPayment)
                                        <a
                                            href="{{ route('teacher-payments.show', $teacherPayment) }}"
                                            class="mr-1"
                                        >
                                            <button
                                                type="button"
                                        ...
                                        @endcan @can('delete', $teacherPayment)
                                        <form
                                            action="{{ route('teacher-payments.destroy', $teacherPayment) }}"
                                            method="POST"

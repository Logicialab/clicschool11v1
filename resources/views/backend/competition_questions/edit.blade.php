<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            @lang('crud.competition_questions.edit_title')
        </h2>
    </x-slot>
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <x-partials.card>
                ...
                <x-form
                    method="PUT"
                    action="{{ route('competition-questions.update', $competitionQuestion) }}"
                    class="mt-4"
                >
                    @include('backend.competition_questions.form-inputs')

<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            @lang('crud.competition_questions.index_title')
        </h2>
    </x-slot>
                ...
                <div class="mb-5 mt-4">
                    <div class="flex flex-wrap justify-between">
                        ...
                        <div class="md:w-1/2 text-right">
                            @can('create',
                            App\Models\CompetitionQuestion::class)
                            <a
                ...
                <div class="block w-full overflow-auto scrolling-touch">
                    <table class="w-full max-w-full mb-4 bg-transparent">
                        ...
                        <tbody class="text-gray-600">
                            @forelse($competitionQuestions as
                            $competitionQuestion)
                            <tr class="hover:bg-gray-50">
                                ...
                                >
                                    ...
                                    >
                                        ...
                                        <a
                                            href="{{ route('competition-questions.edit', $competitionQuestion) }}"
                                            class="mr-1"
                                        >
                                            <button
                                                type="button"
                                        ...
                                        $competitionQuestion)
                                        <a
                                            href="{{ route('competition-questions.show', $competitionQuestion) }}"
                                            class="mr-1"
                                        >
                                            <button
                                                type="button"
                                        ...
                                        $competitionQuestion)
                                        <form
                                            action="{{ route('competition-questions.destroy', $competitionQuestion) }}"
                                            method="POST"

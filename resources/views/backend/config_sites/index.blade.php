<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            @lang('crud.config_sites.index_title')
        </h2>
    </x-slot>
                ...
                <div class="mb-5 mt-4">
                    <div class="flex flex-wrap justify-between">
                        ...
                        <div class="md:w-1/2 text-right">
                            ...
                            <a
                                href="{{ route('config-sites.create') }}"
                                class="button button-primary"
                            >
                ...
                <div class="block w-full overflow-auto scrolling-touch">
                    <table class="w-full max-w-full mb-4 bg-transparent">
                        ...
                        <tbody class="text-gray-600">
                            @forelse($configSites as $configSite)
                            <tr class="hover:bg-gray-50">
                                ...
                                >
                                    ...
                                    >
                                        ...
                                        <a
                                            href="{{ route('config-sites.edit', $configSite) }}"
                                            class="mr-1"
                                        >
                                            <button
                                                type="button"
                                        ...
                                        @endcan @can('view', $configSite)
                                        <a
                                            href="{{ route('config-sites.show', $configSite) }}"
                                            class="mr-1"
                                        >
                                            <button
                                                type="button"
                                        ...
                                        @endcan @can('delete', $configSite)
                                        <form
                                            action="{{ route('config-sites.destroy', $configSite) }}"
                                            method="POST"

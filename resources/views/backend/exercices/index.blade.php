<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            @lang('crud.exercices.index_title')
        </h2>
    </x-slot>
                            ...
                            <tr class="hover:bg-gray-50">
                                ...
                                >
                                    ...
                                    >
                                        @can('update', $exercice)
                                        <a
                                            href="{{ route('exercices.edit', $exercice) }}"
                                            class="mr-1"
                                        >
                                            <button
                                                type="button"
                                        ...
                                        @endcan @can('view', $exercice)
                                        <a
                                            href="{{ route('exercices.show', $exercice) }}"
                                            class="mr-1"
                                        >
                                            <button
                                                type="button"
                                        ...
                                        @endcan @can('delete', $exercice)
                                        <form
                                            action="{{ route('exercices.destroy', $exercice) }}"
                                            method="POST"
